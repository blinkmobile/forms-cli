...
function processForm (options) {
  ...
  return definition.reduce((memo, form) => {
    ...
    // console.log('start normalisation')
    // console.log(t.transduce(normalisation, accum, {}, form))
    // console.log('end normalisation')
    const moduleOptions = t.transduce(normalisation, accum, {}, form) //Object.assign({}, form.default, {modelName: angularName})
