...
const getDefaultForm = (f) => {
  log.debug('getDefault', JSON.stringify(f))
  return f[0].toLowerCase() === 'default'
}
...
function normaliseArrays (form) {
  log.debug('====================== start original form')
  log.debug(JSON.stringify(form))
  log.debug('====================== end original form')
  ...
  log.debug('====================== start extracted form')
  log.debug(JSON.stringify(form))
  log.debug('====================== end extracted form')
