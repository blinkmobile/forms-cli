...
const ERROR_MESSAGE = 'Answerspace url is not valid'
...
function fetchAnswerspaceId (answerspaceUrl) {
  ...
  return fetch(configUrl)
          ...
          .catch(() => Promise.reject(new Error(ERROR_MESSAGE))) // makes inquirier print a better error than what fetch.json() does
}
